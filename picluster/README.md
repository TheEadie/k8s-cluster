...
k3sup install --ip 192.168.1.101 --user pi --k3s-channel stable --k3s-extra-args '--no-deploy traefik --no-deploy servicelb' --context pi --merge --local-path ~/.kube/config 
k3sup join --ip 192.168.1.102 --server-ip 192.168.1.101 --user pi --k3s-channel stable
```
